...
group      2 0.063237 0.031619  3.0067 0.09497           0.1568
...
\begin{center}\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-168-1} \end{center}
...
\caption{Predicted pathway model of primate brain evolution taken from Dunbar and Shultz (2007).}\label{fig:unnamed-chunk-170}
\end{figure}
...
\caption{Example of a simple directed acyclic graph from Gonzalez-Voyer and Von Hardenberg 2014.}\label{fig:unnamed-chunk-171}
\end{figure}
...
\begin{center}\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-177-1} \end{center}
...
{\centering \includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-189-1} 

}

\caption{Maximum likelihood reconstruction of the evolution of conspicuous sexual swellings in macaques using an equal rates model of evolution.}\label{fig:unnamed-chunk-189}
\end{figure}
...
\begin{center}\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-201-1} \end{center}
...
\begin{center}\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-202-1} \end{center}
...
\begin{center}\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-205-1} \end{center}
