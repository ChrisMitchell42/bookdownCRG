...
```{r, echo=FALSE, eval=TRUE, fig.cap="Plot of weight gain in corncrake hatchlings reared on four different nutritional supplements and a control group. The mean and standard deviation of each group is plotted in blue. the mean weight gain across the entire sample is plotted in red.", fig.width=5}
ggplot(data = corncrake, aes(x = Supplement, y = WeightGain)) +
  ...
  geom_point(stat = "summary", fun.y = "mean", size = 3, colour = "blue") +
